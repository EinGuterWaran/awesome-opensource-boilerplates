...
- [SaaS Starter by Cloudrix](https://github.com/sayahweb2-png/saas-starter-lite) - Production-ready NestJS + Angular SaaS boilerplate with JWT/OAuth/2FA auth, Stripe billing, multi-tenancy, RBAC, BullMQ, Docker, and Terraform.
...
- [SaaS Starter by Cloudrix](https://github.com/sayahweb2-png/saas-starter-lite) - NestJS + Angular SaaS boilerplate with auth, Stripe, multi-tenancy, and MIT license.
